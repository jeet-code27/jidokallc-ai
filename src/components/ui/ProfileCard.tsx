...
const DEFAULT_INNER_GRADIENT = 'linear-gradient(145deg, rgba(13, 17, 23, 0.9) 0%, rgba(101, 181, 245, 0.2) 100%)';
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  const cardStyle = useMemo(
    () => ({
      ...
      '--behind-glow-color': behindGlowColor ?? 'rgba(101, 181, 245, 0.67)',
